  ...
  codes={[
    {
      code: `const home = {
    label: "Home",
    title: "Fayyez Farrukh's Portfolio",
    description: "Portfolio website showcasing my work as a Software Engineer",
    headline: <>Software engineer and builder</>,
    subline: (
      <>
        I'm Fayyez, a software engineer. I specialize in crafting diverse software solutions that prioritize user experience and performance aimed at reducing friction in the business process(es).
      </>
    ),
};`,
      language: "tsx",
